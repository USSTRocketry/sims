...
# Basic analysis info
filename = BASE_DIR / "Up2Down_DrogueOnly"
print("Filename is:")
print(filename)
...
for setting in flight_settings(analysis_parameters, number_of_simulations):
    ...
    # Main parachute DISABLED for this variant of the script.
    # The rocket descends under Drogue only, from apogee all the way
    # to ground impact. The add_parachute call below is commented out
    # rather than deleted so it can be easily restored later.
    #
...
output_folder_svg = str(BASE_DIR / "images_drogue_only" / "svg")
os.makedirs(output_folder_svg, exist_ok=True)

# Create an output folder for pickle files
output_folder_pickle = str(BASE_DIR / "images_drogue_only" / "pickle")
